...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); Job (ID: `person:Job`); LORD (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Bless (ID: `keyterm:Bless`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** Chaldea (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Camel (ID: `fauna:Camel`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** Temanites (ID: `group:Teman`); Eliphaz (ID: `person:Eliphaz.2`); Zophar (ID: `person:Zophar`); Bildad (ID: `person:Bildad`); Naamathites (ID: `group:Naamathites`); Shuhites (ID: `group:Shuhites`); Job (ID: `person:Job`); Teman (ID: `place:Teman`)
...
* **Associated ACAI Concepts:** Tema (ID: `place:Tema`); Trust (ID: `keyterm:LeanOn`); Sheba (ID: `place:Sheba.2`)
...
He says that people do not rise up again, and will not be roused out of their sleep.
...
* **Associated ACAI Concepts:** Understanding (ID: `keyterm:Understanding`); Naamathites (ID: `group:Naamathites`); Zophar (ID: `person:Zophar`)
...
* **Associated ACAI Concepts:** Be (Or Show Oneself) Just (ID: `keyterm:Just`); LORD (ID: `deity:Lord`); Complete (ID: `keyterm:Complete`)
...
* **Associated ACAI Concepts:** Adam (ID: `person:Adam`); Passion (ID: `keyterm:Ardour`); Rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** Buzites (ID: `group:Buzites`); Ram (ID: `person:Ram.3`); Elihu (Friend of Job). (ID: `person:Elihu.5`); Barachel (ID: `person:Barachel`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Job (ID: `person:Job`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Buzites (ID: `group:Buzites`); Elihu (Friend of Job). (ID: `person:Elihu.5`); Barachel (ID: `person:Barachel`); Fear (ID: `keyterm:Fear`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Job (ID: `person:Job`); Understanding (ID: `keyterm:Understanding`); Perceive (ID: `keyterm:Perceive`)
...
* **Associated ACAI Concepts:** Intention (ID: `keyterm:Intention`); Straightness (ID: `keyterm:Straightness`); Job (ID: `person:Job`)
...
* **Associated ACAI Concepts:** Be (Or Show Oneself) Just (ID: `keyterm:Just`); Job (ID: `person:Job`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Job (ID: `person:Job`); Have Insight (ID: `keyterm:HaveInsight`); Intention (ID: `keyterm:Intention`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Elihu (Friend of Job). (ID: `person:Elihu.5`)
...
* **Associated ACAI Concepts:** Foolish (ID: `keyterm:Foolish`); Job (ID: `person:Job`); Offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Job (ID: `person:Job`); LORD (ID: `deity:Lord`); Bless (ID: `keyterm:Bless`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Camel (ID: `fauna:Camel`); Donkey (ID: `fauna:Donkey`); Flock (ID: `fauna:Flock`)
