...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); To Sin (ID: `keyterm:Sin`); LORD (ID: `deity:Lord`); Bless (ID: `keyterm:Bless`); Job (ID: `person:Job`); Holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Chaldeans (ID: `group:Chaldea`); Chaldea (ID: `place:Chaldea`); Sword (ID: `realia:Sword`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** Shuhites (ID: `group:Shuhites`); Bildad (ID: `person:Bildad`); Naamathites (ID: `group:Naamathites`); Temanites (ID: `group:Teman`); Eliphaz (ID: `person:Eliphaz.2`); Zophar (ID: `person:Zophar`); Teman (ID: `place:Teman`); Job (ID: `person:Job`)
...
* **Associated ACAI Concepts:** Naamathites (ID: `group:Naamathites`); Understanding (ID: `keyterm:Understanding`); Zophar (ID: `person:Zophar`)
...
* **Associated ACAI Concepts:** Complete (ID: `keyterm:Complete`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Complete (ID: `keyterm:Complete`); Job (ID: `person:Job`); Barley (ID: `flora:Barley`); Thistle (ID: `flora:Thistle`); Weed (ID: `flora:Weed`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Buzites (ID: `group:Buzites`); Barachel (ID: `person:Barachel`); Elihu (Friend of Job). (ID: `person:Elihu.5`); Ram (ID: `person:Ram.3`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); LORD (ID: `deity:Lord`); Job (ID: `person:Job`)
...
* **Associated ACAI Concepts:** Buzites (ID: `group:Buzites`); Barachel (ID: `person:Barachel`); Elihu (Friend of Job). (ID: `person:Elihu.5`); Ability (ID: `keyterm:Ability`); Fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** Intention (ID: `keyterm:Intention`); Job (ID: `person:Job`); Straightness (ID: `keyterm:Straightness`)
...
* **Associated ACAI Concepts:** Intention (ID: `keyterm:Intention`); Job (ID: `person:Job`); Have Insight (ID: `keyterm:HaveInsight`)
...
* **Associated ACAI Concepts:** Job (ID: `person:Job`); Perceive (ID: `keyterm:Perceive`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); Foolish (ID: `keyterm:Foolish`); Job (ID: `person:Job`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Bless (ID: `keyterm:Bless`); Job (ID: `person:Job`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Donkey (ID: `fauna:Donkey`); Camel (ID: `fauna:Camel`); Flock (ID: `fauna:Flock`)
