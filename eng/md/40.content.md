...
* **Associated ACAI Concepts:** Joseph (ID: `person:Joseph.4`); Egypt (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** Zebedee (ID: `person:Zebedee`); James (ID: `person:James`); John (ID: `person:John.2`)
...
* **Associated ACAI Concepts:** Court Case (ID: `keyterm:CourtCase`); Gehenna (ID: `keyterm:Gehenna`)
...
* **Associated ACAI Concepts:** Plate (ID: `realia:Plate.2`); Clean (ID: `keyterm:Clean`)
...
* **Associated ACAI Concepts:** Angels (ID: `group:Angels`); Resurrection (ID: `keyterm:Resurrection`)
