...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Bethlehem (ID: `place:Bethlehem`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Chilion (ID: `person:Chilion`); Boaz (ID: `person:Boaz`); Naomi (ID: `person:Naomi`); Mahlon (ID: `person:Mahlon`); Elimelech (ID: `person:Elimelech`)
...
* **Associated ACAI Concepts:** Tribe of Judah (ID: `group:Judah`); Tamar (ID: `person:Tamar`); Judah (ID: `person:Judah.4`); LORD (ID: `deity:Lord`); Perez (ID: `person:Perez`)
