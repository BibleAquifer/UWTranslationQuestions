...
* **Associated ACAI Concepts:** Bigtha (ID: `person:Bigtha`); Harbona (ID: `person:Harbona`); Mehuman (ID: `person:Mehuman`); Biztha (ID: `person:Biztha`); Abagtha (ID: `person:Abagtha`); Carkas (ID: `person:Carkas`); Zethar (ID: `person:Zethar`); Ahasuerus (ID: `person:Ahasuerus`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Medan (ID: `person:Medan`); Persians (ID: `group:Persia`); Medes (ID: `group:Mede`); Ahasuerus (ID: `person:Ahasuerus`); Persia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Jehoiachin (ID: `person:Jehoiachin`); Judah (ID: `person:Judah.4`); Babylon (ID: `place:Babylon`); Tribe of Judah (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Hegai (ID: `person:Hegai`); Abihail (ID: `person:Abihail.5`); Esther (ID: `person:Esther`); Favor (ID: `keyterm:Favor`); Mordecai (ID: `person:Mordecai.2`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); Haman (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Haman (ID: `person:Haman`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** Zeresh (ID: `person:Zeresh`); Haman (ID: `person:Haman`); A Group of People (ID: `group:GenericGroup`); Love (ID: `keyterm:Love`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Haman (ID: `person:Haman`); Favor (ID: `keyterm:Favor`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Jews (ID: `group:Jews`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Lot (ID: `keyterm:Lot`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`)
