...
* **Associated ACAI Concepts:** Abagtha (ID: `person:Abagtha`); Mehuman (ID: `person:Mehuman`); Carkas (ID: `person:Carkas`); Biztha (ID: `person:Biztha`); Harbona (ID: `person:Harbona`); Bigtha (ID: `person:Bigtha`); Zethar (ID: `person:Zethar`); Ahasuerus (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Medan (ID: `person:Medan`); Persians (ID: `group:Persia`); Persia (ID: `place:Persia`); Ahasuerus (ID: `person:Ahasuerus`); Medes (ID: `group:Mede`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Jehoiachin (ID: `person:Jehoiachin`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Babylon (ID: `place:Babylon`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Abihail (ID: `person:Abihail.5`); Hegai (ID: `person:Hegai`); Favor (ID: `keyterm:Favor`); Mordecai (ID: `person:Mordecai.2`); Esther (ID: `person:Esther`)
...
* **Associated ACAI Concepts:** Zeresh (ID: `person:Zeresh`); Jews (ID: `group:Jews`); A Group of People (ID: `group:GenericGroup`); Mordecai (ID: `person:Mordecai.2`); Love (ID: `keyterm:Love`); Haman (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Jews (ID: `group:Jews`); Favor (ID: `keyterm:Favor`); Agag (ID: `person:Agag.2`); Agagites (ID: `group:Agag`); Haman (ID: `person:Haman`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Jews (ID: `group:Jews`); Lot (ID: `keyterm:Lot`); Agag (ID: `person:Agag.2`); Agagites (ID: `group:Agag`); Haman (ID: `person:Haman`); Lot (ID: `realia:Lot`)
